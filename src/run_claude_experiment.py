...
from llm_claude import ClaudeLLMClient
...
def main():
    ...
    # 2) Inizializza LLM Claude
    llm = ClaudeLLMClient(model_name="claude-sonnet-4-5")
    ...
    print(f"\n✅ Risultati Claude salvati in: {RESULTS_FILE}")
